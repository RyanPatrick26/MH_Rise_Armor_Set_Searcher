...
public class ArmorViewModel extends AndroidViewModel {
    ...
    public ArmorViewModel(@NonNull Application application) {
        super(application);
        armorRepository = new ArmorRepository(application.getApplicationContext());
    ...
    public LiveData<List<Armor>> getAllArmorOfRarity(int[] rarities, Gender gender){return armorRepository.getAllArmorOfRarity(rarities, gender);}
